...
public class Remover_Aluguer extends JFrame{
...
public void inicializacao() {
    ...
    JLabel label_dados_funcionarios = new JLabel("Pesquisa pelo ID");
    ...
    label_id_aluguer = new JLabel("ID Aluguer");
	...
	btn_cadastrar.addActionListener(new ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt) {
        	...
        	if(passou==false) {
        		...
        		int id= Integer.parseInt(txt_id_aluguer.getText());
        		List<Aluguer> lista= aluguerDAO.listar();
        		for(int i= 0; i<lista.size(); i++) {
        			if(lista.get(i).getIDAluguer()==id){
        				aluguerDAO.remover(id);
                		passou= true;
                		JOptionPane.showMessageDialog(null, "Aluguer removida!");
        			}
        		}
        		...
        		if(passou==true) {
        			...
        			txt_id_aluguer.setText("");
        			JOptionPane.showMessageDialog(null, "ID do Aluguer nao encontrada");
        		}
        		
        	}else {
        		JOptionPane.showMessageDialog(null, "Aluguer nao removida!");
        	}
...
private void adicionarPaneis(String opcao) {
    ...
    switch (opcao) {
        ...
        case "cancelar":
        	Tela_Aluguer tela = new Tela_Aluguer();
            this.dispose();
            tela.show();
            break;
