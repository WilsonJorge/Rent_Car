...
public class Remover_Cliente extends JFrame{
...
public void inicializacao() {
    ...
    JLabel label_dados_funcionarios = new JLabel("Pesquisa pelo ID do Cliente");
    ...
    label_id_aluguer = new JLabel("ID Cliente");
    ...
    txt_id_aluguer.setTextoFundo("Digite o ID do Cliente");
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
        	...
        	if(passou==false) {
        		...
        		for(int i= 0; i<lista.size(); i++) {
        			if(lista.get(i).getBICliente()==id){
        		...
        		if(passou==true) {
        			...
        			txt_id_aluguer.setText("");
        			JOptionPane.showMessageDialog(null, "BI do Cliente nao encontrada");
        		}
        		
        	}else {
        		JOptionPane.showMessageDialog(null, "Cliente nao removida!");
        	}
