...
public class Actualizar_Dados_Aluguer extends JFrame{
...
//private TelaEstudante pane;
   ...
   public Actualizar_Dados_Aluguer()
  { 
	   inicializacao();
	   eventosButoes();
    		...
    		new ActionListener() {
    			public void actionPerformed(ActionEvent e) {
    				...
    				if(passou==false) {
	    				...
	    				aluguerDAO.alterar(aluguer);
	    				passou= true;
	    				JOptionPane.showMessageDialog(null, "Aluguer Actualizado!");
	    				if(passou==true) {
