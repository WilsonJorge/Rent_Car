...
public class Actualizar_Dados_Funcionario extends JFrame {
    ...
    public Actualizar_Dados_Funcionario() {
        
       
    }

    public void dadosSet(List<Funcionario> lista,int i)
    {
        ...
        txt_mome_funcionario.setTextoFundo(lista.get(i).getNomeFuncionario());
        ...
        txt_BI.setTextoFundo(lista.get(i).getBI_Funcionario());
        ...
        txt_salario.setTextoFundo(Integer.toString(lista.get(i).getSalario()));
        ...
        text_funcao.setModel(new DefaultComboBoxModel<>(new String[]{lista.get(i).getFuncao(), "Secretaria"}));
        ...
        btn_cadastrar.addActionListener(
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (passou == false) {
                    ...
                    Funcionario funcionario = new Funcionario(nome, bi_funcionario, salario, funcao);
