...
public class Actualizar_Dados_Viatura extends JFrame{
   ...
   private JRadioButton resposta2,resposta1,resp1,resp2,sim,nao;
//private TelaEstudante pane;

   public Actualizar_Dados_Viatura()
  { 
	   inicializacao();
	   eventosButoes();
...
public void inicializacao() {
    ...
    pane_dados.setBounds(10, 10, 792, 370);
    ...
    label_dados_vituras.setBackground(new Color(72, 73, 66));
    ...
    JComboBox text_marca = new JComboBox<>();
    ...
    JRadioButton resp1 = new JRadioButton("Nao");
    ...
    JRadioButton resp2 = new JRadioButton("Sim");
    ...
    JRadioButton resposta1 = new JRadioButton("Nao");
    ...
    JRadioButton resposta2 = new JRadioButton("Sim");
   ...
   //Defenicao dos butoes
    btn_cadastrar = new Botao("Actualizar");
    ...
    btn_cadastrar.setBounds(190, 330, 190, 30);
    			...
    			public void actionPerformed(ActionEvent e) {
    				...
    				if(passou==false) {
	    			  ...
	    			  Viatura viatura= new Viatura(matricula,marca,modelo,seguros,inspencao,manutencao,preco,bi_funcionario,bi_cliente,id_aluguer);
	    				...
	    				viaturaDAO.alterar(viatura);
	    				passou= true;
	    				JOptionPane.showMessageDialog(null, "Viatura  Actualizada!");
	    				if(passou==true) {
    					...
    					JOptionPane.showMessageDialog(null, "Viatura nao Actualizada! Consulte o erro");
    					passou= false;
    				}
    			}
    		}
